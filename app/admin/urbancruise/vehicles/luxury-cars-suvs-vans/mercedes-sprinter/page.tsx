...
import {
  ...
  MdOutlineCompareArrows, MdOutlineSearch, MdOutlineExplore,
...
export default function MercedesSprinterPage() {
  const basePath = '/admin/urbancruise/vehicles/luxury-cars-suvs-vans/mercedes-sprinter';
  return (
    <div className="p-6 md:p-8">
      <div className="mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Mercedes Sprinter</h1>
      </div>
