...
import {
  ...
  MdOutlineAttachMoney, MdOutlineSearch, MdOutlineExplore,
  MdOutlineHelp, MdOutlineLocationOn, MdOutlineHandshake, MdOutlinePhoneAndroid,
} from 'react-icons/md';
...
export default function LuxuryVansPage() {
  const basePath = '/admin/urbancruise/vehicles/luxury-cars-suvs-vans/luxury-vans';
  return (
    <div className="p-6 md:p-8">
      <div className="mb-8">
        <Link href="/admin/urbancruise/vehicles/luxury-cars-suvs-vans" className="text-sm text-blue-600 hover:text-blue-700 mb-2 inline-block">
          ← Back to Luxury Cars, SUVs, Vans
        </Link>
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Luxury Vans</h1>
      </div>
