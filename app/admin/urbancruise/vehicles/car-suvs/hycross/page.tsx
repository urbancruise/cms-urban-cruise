...
export default function HycrossPage() {
  const basePath = '/admin/urbancruise/vehicles/car-suvs/hycross';

  return (
    <div className="p-6 md:p-8">
      <div className="mb-8">
        <Link href="/admin/urbancruise/vehicles/car-suvs" className="text-sm text-blue-600 hover:text-blue-700 mb-2 inline-block">
          ← Back to Car & SUVs
        </Link>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <MdOutlineArrowForward className="w-4 h-4 text-gray-400 group-hover:text-blue-600 ml-auto transition-colors" />
              </div>
            </Link>
          );
        })}
