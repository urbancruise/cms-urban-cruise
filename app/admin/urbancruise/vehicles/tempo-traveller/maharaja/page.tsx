...
export default function MaharajaPage() {
  const basePath = '/admin/urbancruise/vehicles/tempo-traveller/maharaja';
  return (
    <div className="p-6 md:p-8">
      <div className="mb-8">
        <Link href="/admin/urbancruise/vehicles/tempo-traveller" className="text-sm text-blue-600 hover:text-blue-700 mb-2 inline-block">
          ← Back to Tempo Traveller
        </Link>
