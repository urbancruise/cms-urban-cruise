...
export default function TempoTravellerPage() {
  const basePath = '/admin/urbancruise/vehicles/tempo-traveller';
    ...
    <div className="p-6 md:p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">
          Manage Tempo Traveller sections
        </p>
      </div>
        ...
        {vehicleSections.map((section) => {
          ...
          return (
            <Link key={section.slug} href={`${basePath}/${section.slug}`}
              className="group bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 hover:shadow-md hover:border-blue-300 transition-all">
