...
export default function VolvoBusPage() {
  const basePath = '/admin/urbancruise/vehicles/luxury-buses/volvo-bus';
  return (
    <div className="p-6 md:p-8">
      <div className="mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Volvo Bus</h1>
      </div>
