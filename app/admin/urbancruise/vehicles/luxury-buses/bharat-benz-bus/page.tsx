...
export default function BharatBenzPage() {
  const basePath = '/admin/urbancruise/vehicles/luxury-buses/bharat-benz-bus';
  return (
    <div className="p-6 md:p-8">
      <div className="mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Bharat Benz Bus</h1>
      </div>
